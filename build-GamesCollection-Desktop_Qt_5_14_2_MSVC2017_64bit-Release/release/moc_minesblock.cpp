...
QT_MOC_LITERAL(1, 11, 9), // "leftClick"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 10) // "rightClick"

    },
    "MinesBlock\0leftClick\0\0rightClick"
};
...
void MinesBlock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MinesBlock *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MinesBlock::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MinesBlock::leftClick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MinesBlock::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MinesBlock::rightClick)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MinesBlock::leftClick()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MinesBlock::rightClick()
{
