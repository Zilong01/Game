...
#include<QDebug>
#include<QSound>
vector<vector<bool>>TetrisLogic1:: map;//地图初始化在游戏场景中
int TetrisLogic1::xNum=10;
int TetrisLogic1::yNum=20;
int TetrisLogic1:: changeTimes=5;
int TetrisLogic1:: score=0;
bool TetrisLogic1::gameOver=false;
//bool TetrisLogic::lineClear=false;

TetrisLogic1::Difficulty TetrisLogic1::difficulty=NORMAL;

Point TetrisLogic1::shape[7][4][4]={
...
TetrisLogic1::TetrisLogic1(QObject *parent) : QObject(parent)
{
    //初始化x y curent值
    newBlock();
}
...
void TetrisLogic1::newBlock(){
        ...
        //重置可旋转次数
        if(TetrisLogic1::difficulty==TetrisLogic1::NORMAL)
            TetrisLogic1::changeTimes=15;
        else if(TetrisLogic1::difficulty==TetrisLogic1::DIFFICULT)
            TetrisLogic1::changeTimes=5;
        else if(TetrisLogic1::difficulty==TetrisLogic1::EPIC){
            TetrisLogic1::changeTimes=4;
        }
...
bool TetrisLogic1::checkChange(int moveX, int moveY, bool isChangeState)
{
...
void TetrisLogic1::move(moveDirection direction)
{
...
void TetrisLogic1::clearPrevious(){
//在改变坐标之前清楚当前位置map上的值
    for(int i=0;i<4;i++){
